function simulations_clock_model
  ...
  temperatures_spaced = linspace(left_bound, right_bound, number_of_points);
  temperatures = [temperatures_spaced temperatures_zoom_T1 temperatures_zoom_T2];
  ...
  save('q6_chi10-100_tol5e-8_all_points.mat', 'sim')
