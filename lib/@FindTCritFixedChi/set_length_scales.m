function obj = set_length_scales(obj)
  ...
  for q_index = 1:numel(obj.q_values)
    for chi_index = 1:numel(obj.chi_values)
      ...
      % YEAH IT DOES MATTER YOU IDIOT
      lattice = Lattice(obj.q_values(q_index), obj.T_pseudocrits(q_index, chi_index));
      ...
      obj.length_scales(q_index, chi_index) = 10.^(6.*lattice.entropy(C, T));
  end
end
